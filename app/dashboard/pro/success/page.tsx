...
export default function ProSuccessPage() {
  return (
    <div className="min-h-screen bg-stone-50 px-5 pt-14 pb-8 flex flex-col gap-6 max-w-sm mx-auto">
      <div>
        <p className="text-xs text-stone-400 uppercase tracking-widest font-light">Benvenuto</p>
        <h1 className="mt-1 text-2xl font-light text-stone-800">Sei Pro ✦</h1>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-100 p-6 flex flex-col gap-3">
        <p className="text-stone-700 font-light leading-relaxed">
          Il tuo abbonamento è attivo. Da adesso hai accesso a tutti i contenuti Sobre, ogni giorno.
        </p>
        <p className="text-sm text-stone-400 font-light">
          Prenditi cura di te, con calma.
        </p>
      </div>
